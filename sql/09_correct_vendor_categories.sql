...
SELECT
    ...
    ROUND(median_days_late::numeric, 2)
        AS median_days_late,
    ...
    CASE
        WHEN vendor = 'SCMS from RDC'
            THEN 'Review internal distribution performance'
...
ORDER BY
    CASE review_category
        WHEN 'Urgent reliability review' THEN 1
        WHEN 'Reliability review' THEN 2
        WHEN 'Review internal distribution performance' THEN 3
        WHEN 'Monitor' THEN 4
        WHEN 'Reliable benchmark' THEN 5
    END,
